 ...
 public class ApplicationRoleService : IApplicationRoleService
    {
        ...
        public CustomRole Add(CustomRole appRole)
        {
        ...
        public IEnumerable<CustomRole> GetAll(int page, int pageSize, out int totalRow, string filter = null)
        {
        ...
        public CustomRole GetDetail(int id)
        {
        ...
        public void Update(CustomRole AppRole)
        {
